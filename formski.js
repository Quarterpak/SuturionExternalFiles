  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      var serialized = _form_serialize(
        document.getElementById('_form_48_')
      ).replace(/%0A/g, '\\n');
      var err = form_to_submit.querySelector('._form_error');
      ...
      async function submitForm() {
        ...
        const response = await fetch(
          'https://suturion.activehosted.com/proc.php?jsonp=true',
          {
            headers: {
      ...
      if (formSupportsPost) {
        ...
        _load_script(
          'https://suturion.activehosted.com/proc.php?' +
            serialized +
            '&jsonp=true',
          null,
          true
